...
console.log(wishlistData.value);
...
const confirmRemove = () => {
  wishlistData.value = wishlistData.value.filter(item => item.id !== selectedProduct.value.id)
  localStorage.setItem('wishlist', JSON.stringify(wishlistData.value))
         ...
         <AccountOverviewSidebar />
            ...
            <div class="col-md-9 col-xl-8 ">
              <div class="row mb-2 mt-3 mt-xl-0">
                ...
                <div v-if="wishlistData && wishlistData.length" class="row mt-3 mt-md-0">
                  <div class="col mt-xl-4">
                    <div v-for="(favorite,product) in wishlistData" :key="product" class="row border mb-3 p-1 p-md-2">
